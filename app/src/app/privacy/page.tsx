      ...
      <main className="max-w-4xl mx-auto px-4 py-12">
        ...
        <div className="prose prose-gray dark:prose-invert max-w-none space-y-6 text-gray-700 dark:text-gray-300 text-sm leading-relaxed">
          ...
          <section>
            ...
            <p>For privacy-related questions, contact us at <a href="mailto:aravind@volt-spark.in" className="text-brand-600 hover:underline">aravind@volt-spark.in</a> or via <a href="https://wa.me/918317308558" target="_blank" rel="noopener noreferrer" className="text-brand-600 hover:underline">WhatsApp</a>.</p>
          </section>
        </div>
      </main>
