...
const bundles = [
  {
    ...
    capabilities: [
      ...
      'Vibration sensors — bearing/motor health, predictive maintenance',
      'Temperature sensors — coolant/oil monitoring, machine overheating alerts',
    ],
  ...
  },
  {
    ...
    capabilities: [
      ...
      'Temperature sensors — cold room/freezer HACCP logging (FSSAI compliance)',
      'Humidity sensors — kitchen ambient monitoring, mold risk, equipment life',
    ],
  ...
  },
  {
    ...
    capabilities: [
      ...
      'Temperature sensors — supply/return air for accurate COP/EER calculation',
      'CO2 + humidity sensors — IAQ monitoring, ASHRAE 62.1 ventilation compliance',
      'Differential pressure sensors — filter health, AHU maintenance alerts',
    ],
  ...
  },
  {
    ...
    capabilities: [
      ...
      'Temperature + humidity sensors — NABH-mandated OT/ICU range logging',
      'Cold storage temperature sensors — blood bank, pharmacy, vaccine chain',
      'Differential pressure sensors — OT positive pressure, isolation room negative pressure',
      'NABH-compatible auto-generated compliance evidence',
    ],
      ...
      <main className="max-w-4xl mx-auto px-4 py-12 space-y-20">
        ...
        <section className="space-y-5">
          ...
          <div className="grid sm:grid-cols-3 gap-4">
            {[
              ...
              { step: '3', title: 'Upgrade with IoT + Intelligence', body: 'When the client is ready, install smart meters and enable the industry intelligence bundle for their vertical. Add the sensors that bundle needs — vibration for manufacturing, temperature for kitchens, CO2 for HVAC, and so on. Real-time data flows in automatically; domain-specific analytics surface exactly what that industry\'s machines are wasting.' },
            ].map((s) => (
        ...
        <section className="rounded-2xl bg-gray-950 dark:bg-gray-900 text-white p-8 space-y-4">
          ...
          <div className="grid sm:grid-cols-3 gap-4 pt-2">
            {[
              { sites: '5 IoT sites', monthly: '₹7,945/mo', annual: '₹95,340/yr' },
              { sites: '10 IoT sites', monthly: '₹15,890/mo', annual: '₹1.91L/yr' },
              { sites: '20 IoT sites', monthly: '₹31,780/mo', annual: '₹3.81L/yr' },
            ].map((r) => (
          ...
          <p className="text-xs text-gray-500 pt-1">Based on avg commission of ₹1,589/IoT site/month (typical site: 1 Advanced + 3 Standard meters + Manufacturing Intelligence bundle = ₹5,296/month client bill, 30% = ₹1,589). Additional to your hardware margin and consulting fees.</p>
