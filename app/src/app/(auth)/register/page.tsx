    ...
    <div className="w-full max-w-md">
      <div className="card p-8">
        <div className="text-center mb-6">
          ...
          <p className="text-sm text-gray-500 mt-1">Start managing energy compliance today</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-3">
          ...
          <div>
            ...
            <input type="text" value={companyName} onChange={(e) => setCompanyName(e.target.value)} className="input-field" placeholder="Your consulting firm or company" />
          </div>
          ...
          <div>
            ...
            <input type="password" value={password} onChange={(e) => setPassword(e.target.value)} className="input-field" placeholder="At least 8 characters" required />
          </div>
